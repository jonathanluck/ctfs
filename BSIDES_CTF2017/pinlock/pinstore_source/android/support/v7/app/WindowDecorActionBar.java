...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    class C02093 implements ViewPropertyAnimatorUpdateListener {
        C02093() {
        }
    ...
    class C02222 extends ViewPropertyAnimatorListenerAdapter {
        C02222() {
        }
    ...
    public WindowDecorActionBar(Activity activity, boolean overlayMode) {
        ...
        this.mHideListener = new C02211();
        this.mShowListener = new C02222();
        this.mUpdateListener = new C02093();
