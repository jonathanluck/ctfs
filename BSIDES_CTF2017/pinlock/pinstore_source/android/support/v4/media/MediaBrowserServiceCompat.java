...
public abstract class MediaBrowserServiceCompat extends Service {
    ...
    private final class ServiceHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case C0175R.styleable.Toolbar_contentInsetLeft /*7*/:
    ...
    class C01833 extends Result<List<MediaItem>> {
        final /* synthetic */ ConnectionRecord val$connection;
        final /* synthetic */ Bundle val$options;
        final /* synthetic */ String val$parentId;

        C01833(Object x0, ConnectionRecord connectionRecord, String str, Bundle bundle) {
    ...
    class C01844 extends Result<MediaItem> {
        final /* synthetic */ ResultReceiver val$receiver;

        C01844(Object x0, ResultReceiver resultReceiver) {
            this.val$receiver = resultReceiver;
            super(x0);
        }
    ...
    private class ServiceImplApi23 extends ServiceImplApi21 implements android.support.v4.media.MediaBrowserServiceCompatApi23.ServiceImplApi23 {
        ...
        class C01851 extends ResultReceiver {
            final /* synthetic */ ItemCallback val$cb;

            C01851(Handler x0, ItemCallback itemCallback) {
        ...
        public void getMediaItem(String mediaId, ItemCallback cb) {
            this.mServiceImpl.getMediaItem(mediaId, new C01851(MediaBrowserServiceCompat.this.mHandler, cb));
        }
    }
    ...
    private void performLoadChildren(String parentId, ConnectionRecord connection, Bundle options) {
        Result<List<MediaItem>> result = new C01833(parentId, connection, parentId, options);
        if (options == null) {
            onLoadChildren(parentId, result);
        } else {
    ...
    private void performLoadItem(String itemId, ResultReceiver receiver) {
        Result<MediaItem> result = new C01844(itemId, receiver);
