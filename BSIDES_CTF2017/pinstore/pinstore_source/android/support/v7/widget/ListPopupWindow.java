        ...
        if (isShowing() && keyCode != 62 && (this.mDropDownList.getSelectedItemPosition() >= 0 || !isConfirmKey(keyCode))) {
            ...
            if (!(below && keyCode == 19 && curIndex <= firstItem) && (below || keyCode != 20 || curIndex < lastItem)) {
                ...
                if (this.mDropDownList.onKeyDown(keyCode, event)) {
                    ...
                    show();
                    switch (keyCode) {
                        case C0175R.styleable.Toolbar_collapseContentDescription /*19*/:
                        case C0175R.styleable.Toolbar_navigationIcon /*20*/:
                        case C0175R.styleable.Toolbar_titleTextColor /*23*/:
                        case C0175R.styleable.AppCompatTheme_textAppearanceSearchResultSubtitle /*66*/:
                            return true;
                    }
