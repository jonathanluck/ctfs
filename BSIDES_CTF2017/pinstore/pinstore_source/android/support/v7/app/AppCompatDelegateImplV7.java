...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    class C01331 implements Runnable {
        ...
        public void run() {
            ...
            if ((AppCompatDelegateImplV7.this.mInvalidatePanelMenuFeatures & AccessibilityNodeInfoCompat.ACTION_SCROLL_FORWARD) != 0) {
                AppCompatDelegateImplV7.this.doInvalidatePanelMenu(C0175R.styleable.AppCompatTheme_ratingBarStyleSmall);
            }
    ...
    private static final class PanelFeatureState {
        ...
        private static class SavedState implements Parcelable {
            ...
            static class C02071 implements ParcelableCompatCreatorCallbacks<SavedState> {
                C02071() {
                }
            ...
            static {
                CREATOR = ParcelableCompat.newCreator(new C02071());
            }
        }
    ...
    class C02042 implements OnApplyWindowInsetsListener {
        C02042() {
        }
    ...
    class C02053 implements OnFitSystemWindowsListener {
        C02053() {
        }
    ...
    class C02064 implements OnAttachListener {
        C02064() {
        }
    ...
    private final class ActionMenuPresenterCallback implements MenuPresenter.Callback {
        ...
        public boolean onOpenSubMenu(MenuBuilder subMenu) {
            ...
            if (cb != null) {
                cb.onMenuOpened(C0175R.styleable.AppCompatTheme_ratingBarStyleSmall, subMenu);
            }
            return true;
        }
    ...
    class ActionModeCallbackWrapperV7 implements ActionMode.Callback {
        ...
        public void onDestroyActionMode(ActionMode mode) {
            ...
            if (AppCompatDelegateImplV7.this.mActionModeView != null) {
                ...
                AppCompatDelegateImplV7.this.mFadeAnim.setListener(new C02201());
            }
        ...
        if (!this.mSubDecorInstalled) {
            ...
            if (!isDestroyed()) {
                if (st == null || st.menu == null) {
                    invalidatePanelMenu(C0175R.styleable.AppCompatTheme_ratingBarStyleSmall);
                }
            }
        }
    }
    ...
    private ViewGroup createSubDecor() {
        ...
        if (a.hasValue(C0138R.styleable.AppCompatTheme_windowActionBar)) {
            if (a.getBoolean(C0138R.styleable.AppCompatTheme_windowNoTitle, false)) {
                ...
                requestWindowFeature(C0175R.styleable.AppCompatTheme_ratingBarStyleSmall);
            }
            if (a.getBoolean(C0138R.styleable.AppCompatTheme_windowActionBarOverlay, false)) {
                requestWindowFeature(C0175R.styleable.AppCompatTheme_seekBarStyle);
            }
            ...
            if (this.mWindowNoTitle) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(subDecor, new C02042());
                } else {
                    ((FitWindowsViewGroup) subDecor).setOnFitSystemWindowsListener(new C02053());
                }
                ...
                if (this.mOverlayActionBar) {
                    this.mDecorContentParent.initFeature(C0175R.styleable.AppCompatTheme_seekBarStyle);
                }
            ...
            contentView.setAttachListener(new C02064());
            return subDecor;
        }
        a.recycle();
    ...
    public boolean requestWindowFeature(int featureId) {
        ...
        if (this.mWindowNoTitle && featureId == C0175R.styleable.AppCompatTheme_ratingBarStyleSmall) {
            return false;
        }
        ...
        switch (featureId) {
            ...
            case WearableExtender.SIZE_FULL_SCREEN /*5*/:
                ...
                return true;
            case C0175R.styleable.Toolbar_titleTextAppearance /*10*/:
                throwFeatureRequestIfSubDecorInstalled();
                this.mOverlayActionMode = true;
                return true;
            case C0175R.styleable.AppCompatTheme_ratingBarStyleSmall /*108*/:
                throwFeatureRequestIfSubDecorInstalled();
                this.mHasActionBar = true;
                return true;
            case C0175R.styleable.AppCompatTheme_seekBarStyle /*109*/:
                throwFeatureRequestIfSubDecorInstalled();
    ...
    void onPanelClosed(int featureId, Menu menu) {
        if (featureId == C0175R.styleable.AppCompatTheme_ratingBarStyleSmall) {
            ActionBar ab = getSupportActionBar();
            if (ab != null) {
    ...
    boolean onKeyUp(int keyCode, KeyEvent event) {
        switch (keyCode) {
            case TransportMediator.FLAG_KEY_MEDIA_PLAY /*4*/:
                ...
                break;
            case C0175R.styleable.AppCompatTheme_colorPrimary /*82*/:
    ...
    private void reopenMenu(MenuBuilder menu, boolean toggleMenuMode) {
        ...
        if (this.mDecorContentParent.isOverflowMenuShowing() && toggleMenuMode) {
            ...
            if (!isDestroyed()) {
                cb.onPanelClosed(C0175R.styleable.AppCompatTheme_ratingBarStyleSmall, getPanelState(0, true).menu);
            }
            ...
            if (st.menu != null && !st.refreshMenuContent && cb.onPreparePanel(0, st.createdPanelView, st.menu)) {
                cb.onMenuOpened(C0175R.styleable.AppCompatTheme_ratingBarStyleSmall, st.menu);
    ...
    private boolean initializePanelMenu(PanelFeatureState st) {
        Context context = this.mContext;
        if ((st.featureId == 0 || st.featureId == C0175R.styleable.AppCompatTheme_ratingBarStyleSmall) && this.mDecorContentParent != null) {
            TypedValue outValue = new TypedValue();
    ...
    private boolean preparePanel(PanelFeatureState st, KeyEvent event) {
        ...
        if (st.featureId == 0 || st.featureId == C0175R.styleable.AppCompatTheme_ratingBarStyleSmall) {
    ...
    private void checkCloseActionMenu(MenuBuilder menu) {
        if (!this.mClosingActionMenu) {
            ...
            Window.Callback cb = getWindowCallback();
            if (!(cb == null || isDestroyed())) {
                cb.onPanelClosed(C0175R.styleable.AppCompatTheme_ratingBarStyleSmall, menu);
            }
    ...
    private void doInvalidatePanelMenu(int featureId) {
        ...
        st.refreshDecorView = true;
        if ((featureId == C0175R.styleable.AppCompatTheme_ratingBarStyleSmall || featureId == 0) && this.mDecorContentParent != null) {
    ...
    private int sanitizeWindowFeatureId(int featureId) {
        if (featureId == 8) {
            ...
            return C0175R.styleable.AppCompatTheme_ratingBarStyleSmall;
        } else if (featureId != 9) {
            return featureId;
        } else {
            Log.i("AppCompatDelegate", "You should now use the AppCompatDelegate.FEATURE_SUPPORT_ACTION_BAR_OVERLAY id when requesting this feature.");
            return C0175R.styleable.AppCompatTheme_seekBarStyle;
        }
    }
