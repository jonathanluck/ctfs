...
public class ViewPager extends ViewGroup {
    ...
    class C01964 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect;
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C01964());
    }
                ...
                if (lp.isDecor) {
                    ...
                    switch (vgrav) {
                        case DEFAULT_GUTTER_SIZE /*16*/:
                            ...
                            break;
                        case C0175R.styleable.AppCompatTheme_homeAsUpIndicator /*48*/:
                            childTop = paddingTop;
                            paddingTop += child.getMeasuredHeight();
                            break;
                        case C0175R.styleable.AppCompatTheme_panelMenuListTheme /*80*/:
    ...
    public boolean executeKeyEvent(KeyEvent event) {
        ...
        switch (event.getKeyCode()) {
            case C0175R.styleable.Toolbar_navigationContentDescription /*21*/:
                return arrowScroll(17);
            case C0175R.styleable.Toolbar_logoDescription /*22*/:
                return arrowScroll(66);
            case C0175R.styleable.AppCompatTheme_popupWindowStyle /*61*/:
                if (VERSION.SDK_INT < 11) {
                    return DEBUG;
                }
